...
def save_img(filename, outputdata, dt, rxnumber, rxcomponent, out_dir):
    ...
    mpl_plot(filename, outputdata, dt, rxnumber, rxcomponent)
    mpl_plot_color(filename, outputdata, dt, rxnumber, rxcomponent)
    ...
    # mpl_plot_fre(filename, fig, dt, rxnumber, rxcomponent)
    ...
    mpl_plot_post(filename, outputdata, dt, rxnumber, rxcomponent)
