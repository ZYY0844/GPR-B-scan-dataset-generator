...
def mpl_plot(filename, outputdata, dt, rxnumber, rxcomponent):
    ...
    out_dir='output-files1/'

    fig = plt.figure(num=filename + ' - rx' + str(rxnumber), figsize=(30, 15), facecolor='w', edgecolor='w')
    ...
    fig.savefig(out_dir + os.sep + savefile + '_test.png', dpi=100, format='png', bbox_inches='tight', pad_inches=0.1)

    return plt

def mpl_plot_post(filename, outputdata, dt, rxnumber, rxcomponent):
    """Creates a plot (with matplotlib) of the B-scan.
    ...
    # savefile = os.path.splitext(filename)[0]
    # fig.savefig(path + os.sep + savefile + '.pdf', dpi=None, format='pdf', bbox_inches='tight', pad_inches=0.1)
    fig.savefig(out_dir + os.sep + savefile + '_post.png', dpi=100, format='png', bbox_inches='tight', pad_inches=0.1)

    return plt

def mpl_plot_color(filename, outputdata, dt, rxnumber, rxcomponent):
    """Creates a plot (with matplotlib) of the B-scan.
    ...
    fig = plt.figure(num=filename + ' - rx' + str(rxnumber), figsize=(15, 15), facecolor='w', edgecolor='w')
    ...
    # savefile = os.path.splitext(filename)[0]
    # fig.savefig(path + os.sep + savefile + '.pdf', dpi=None, format='pdf', bbox_inches='tight', pad_inches=0.1)
    fig.savefig(out_dir + os.sep + savefile + '_color.png', dpi=100, format='png', bbox_inches='tight', pad_inches=0.1)

    return plt

def mpl_plot_fre(filename, outputdata, dt, rxnumber, rxcomponent):
    """Creates a plot (with matplotlib) of the B-scan.
    ...
    # savefile = os.path.splitext(filename)[0]
    # fig.savefig(path + os.sep + savefile + '.pdf', dpi=None, format='pdf', bbox_inches='tight', pad_inches=0.1)
    fig.savefig(out_dir + os.sep + savefile + '_fre.png', dpi=100, format='png', bbox_inches='tight', pad_inches=0.1)
